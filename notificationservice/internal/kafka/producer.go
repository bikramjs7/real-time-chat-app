...
func (p *Producer) SendMessageToMessageTopic(key string, value interface{}) error {
	return p.sendMessage(p.msgWriter, key, value)
}
...
func (p *Producer) Close() error {
	...
	if err := p.msgWriter.Close(); err != nil {
		return err
	}
	return nil
}
